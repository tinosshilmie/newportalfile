...
function addsku(){
	...
	test11 = $( "#batchnolist" ).val();
        ...
        if(parseInt(skuqty) > parseInt($('#balqty').val())){
        ...
        items: [
                ...
                html: function (item) {
                    var html =
                      ...
                      ' Product:'+
		      '    <input id="sku" name="sku"  oninput="onInput()" list="skulist" style="width: 270px" placeholder="Search product"  autocomplete="off" readonly> '+
                      '    <input id="skuqty" style="width: 50px" type="number" placeholder="Qty" min="0" onkeypress="return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode >= 48 && event.charCode <= 57" readonly> /'+
                      '    <input id="balqty" style="width: 50px" type="number" placeholder="Qty" value="0" readonly>'+
                      '    <input id="batchno" style="width: 120px" placeholder="Batch No" readonly>'+
                      '</div>';
                    return html;
                    }
                },{ type: 'html',  id: 'item2',
...
var config2 = {
    layout: {
        name: 'layout2',
        panels: [
            { type: 'top', minSize: 300, overflow: 'hidden' },
    ...
    grid1: {
        ...
        columns: [
            ...
            { field: 'batchno', text: 'Batch No', size: '100px' },
            { field: 'qty', text: 'Qty', size: '50px' },
            { field: 'balqty', text: 'Available Qty', size: '90px' },
    ...
    grid2: {
        ...
        columns: [
            { field: 'Code', text: 'Code', size: '100px' },
            { field: 'product', text: 'Product', size: '100%' },
            { field: 'productgroup', text: 'Product Group', size: '100%' },
            { field: 'batchno', text: 'Batch No', size: '100px' },
            { field: 'qty', text: 'Qty', size: '70px' },
            { field: 'balqty', text: 'Available Qty', size: '100px' },
        ],
        records: [
        ]
